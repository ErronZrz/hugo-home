...
但我的能力不足以定义这个问题的「**结束**」。也许被忽略的错误测试用例正伺机待发，也许还会出现更好的方法，也许哪一天连 AI 都能够在一秒钟之内把这个问题分析透彻（~~可能那个时候人类对地球的统治都已经结束了~~）……

总之，感谢你能读到这里。

最后还需要鸣谢 Windows 计算器对本文的大力支持，如果离开了它纵享丝滑的进制转换以及超大整数运算，我甚至没有机会意识到十进制小数和二进制小数之间的美妙联系。
